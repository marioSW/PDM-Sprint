...
<div id="mainwrapper" class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="home_approver.php"><img src="images/logo.png" alt="" /></a>
        </div>
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="active"><a href="home_approver.php"><span class="iconfa-laptop"></span>Home</a></li>
                <li class="dropdown"><a href=""><span class="iconfa-list-alt"></span> Storage Requests</a>
                	<ul>
                        <li><a href="pending_requests.php">Pending Storage Requests</a></li>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            <li><a href="home_approver.php"><i class="iconfa-home"></i></a> <span class="separator"></span></li>
            <li>Home</li>
                ...
                <div class="row">
                  ...
                  <div class="footer">
                    <div class="footer-left">
                        <span>&copy; 2015.SolutionX6. All Rights Reserved.</span>
                    </div>
                    <div class="footer-right">
                        <span>Designed by: <a href="">SolutionX6</a></span>
                    </div>
                </div><!--footer-->

...
<div id="mainwrapper" class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="home_researcher.php"><img src="images/logo.png" alt="" /></a>
        </div>
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="active"><a href="home_researcher.php"><span class="iconfa-laptop"></span>Home</a></li>
				...
				<ul>
                        ...
                        <li><a href="update_news.php">Progress</a></li>
                    </ul>
				</li>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            <li><a href="home_researcher.php"><i class="iconfa-home"></i></a> <span class="separator"></span></li>
            <li>Home</li>

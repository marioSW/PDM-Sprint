            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-list-alt"></span> Storage Requests</a>
                	<ul style="display: block">
						...
						<li class="active"><a href="accepted_requests.php">Approved Storage Requests</a></li>
    ...
    <div class="rightpanel">
       ...
       <ul class="breadcrumbs">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                <h1><b>Approved Storage Requests</b></h1>
            </div>
        </div><!--pageheader-->
            ...
            <div class="maincontentinner">
                <div class="row">
                    <div id="dashboard-left" class="col-md-8">
					   <h4 class="widgettitle">Approved Requests</h4>
						...
						$sql="SELECT * FROM `system_user` s ,`request` r WHERE r.user_id=s.user_id AND r.request_status='Approved'";

...
<div id="mainwrapper" class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="home_admin.php"><img src="images/logo.png" alt="" /></a>
        </div>
   ...
   <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
				...
				<li class="active" ><a href="home_admin.php"><span class="iconfa-laptop"></span>Home</a></li>
                <li ><a href="admin.php"><span class="iconfa-laptop"></span> View</a></li>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            <li><a href="home_admin.php"><i class="iconfa-home"></i></a> <span class="separator"></span></li>
            <li>Home</li>

            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-list-alt"></span> Storage Requests</a>
                	<ul style="display: block">
						...
						<li class="active"><a href="rejected_requests.php">Rejected Storage Requests</a></li>
                    </ul>
                </li>
    ...
    <div class="rightpanel">
       ...
       <ul class="breadcrumbs">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                <h1><b>Rejected Storage Requests</b></h1>
            </div>
        </div><!--pageheader-->
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                <div class="row">
					...
					<h4 class="widgettitle">Rejected Requests</h4>
						...
						$sql="SELECT * FROM `system_user` s ,`request` r WHERE r.user_id=s.user_id AND r.request_status='Rejected'";
                    ...
                    <thead>
                        <tr>
                           <!--	<th class=\"head0 nosort\"><input type=\"checkbox\" class=\"checkall\" /></th> --->
							...
							<th class=\"head0\">Request Type</th>
